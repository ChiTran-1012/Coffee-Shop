...
const Header = () => {
  return (
    <div className='flex justify-center items-center gap-16 text-[#FFECB8] h-16 py-20'>
      ...
      <Link className='hover:border hover:bg-[#FFECB8] hover:text-[#1d4e1a] px-2 rounded-full'  to="/location">Locations</Link>
      ...
      <Link className='hover:border hover:bg-[#FFECB8] hover:text-[#1d4e1a] px-2 rounded-full'  to="/about">About Us</Link>
      <Link className='hover:border hover:bg-[#FFECB8] hover:text-[#1d4e1a] px-2 rounded-full'  to="/news"> News</Link>
    </div>
  )
}
