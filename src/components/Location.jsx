...
const Location = () => {
  return (
    <div className="bg-[#fcf3d9] py-12 sm:py-16 px-4 sm:px-8 md:px-16 lg:px-36 border-t min-h-screen">
      {/* Tiêu đề */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        {/* Thông tin địa chỉ */}
        <div className="text-[#1d4e1a] space-y-6 text-base sm:text-lg lg:text-xl px-0 lg:pl-12">
          <div>
          ...
          <div>
            <p className="font-semibold text-lg sm:text-xl">⏰ Opening Hours</p>
            <p>Mon - Fri: 7:00 AM – 9:00 PM<br />Sat - Sun: 8:00 AM – 10:00 PM</p>
          </div>

          <div>
            <p className="font-semibold text-lg sm:text-xl">📞 Contact</p>
            <p>Phone: (0123) 456 789<br />Email: hello@brewhaus.com</p>
          </div>
        </div>

        {/* Google Map embed */}
        <div className="w-full h-56 sm:h-72 md:h-96 lg:h-[450px] rounded-2xl overflow-hidden shadow-lg border-2 border-[#1d4e1a]">
          <iframe
